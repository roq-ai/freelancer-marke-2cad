  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Freelancer Marketplace Like Upwork: Unleashing the Power of Remote Work, Connecting Businesses with Top Freelance Talent Globally"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Freelancer Marketplace Like Upwork: Unleashing the Power of Remote Work, Connecting Businesses with Top Freelance Talent Globally`}
            </Text>
            <Box
